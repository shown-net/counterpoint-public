...
from counterpoint.gem5.cli import audit_raw, validate_model
...
def _raw_stat_rows() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.thread_0.numInsts",
            "stat_value": 8.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.commitStats0.committedInstType::MemRead",
            "stat_value": 2.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.commitStats0.committedInstType::MemWrite",
            "stat_value": 1.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.commitStats0.committedInstType::FloatMemRead",
            "stat_value": 0.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.commitStats0.committedInstType::FloatMemWrite",
            "stat_value": 0.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.commitStats0.committedControl::IsControl",
            "stat_value": 3.0,
        },
    ]
    ...
    return [
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.numCycles",
            "stat_value": 20.0,
        },
    ]
...
def _frontend_stall_raw_stat_rows() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.fetchStats0.icacheStallCycles",
            "stat_value": 3.0,
        },
    ]
...
def _branch_raw_stat_rows() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.branchPred.mispredicted_0::total",
            "stat_value": 2.0,
        },
    ]
    ...
    return [
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.dcache.overallAccesses::total",
            "stat_value": 10.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.dcache.ReadReq.accesses::total",
            "stat_value": 6.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.dcache.ReadReq.mshrMisses::total",
            "stat_value": 3.0,
        },
    ]
    ...
    return [
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.l2.overallAccesses::total",
            "stat_value": 20.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.l2.demandAccesses::total",
            "stat_value": 12.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.l2.demandMisses::total",
            "stat_value": 4.0,
        },
    ]
    ...
    return [
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.icache.overallAccesses::total",
            "stat_value": 20.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.icache.demandAccesses::total",
            "stat_value": 12.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.icache.demandMisses::total",
            "stat_value": 4.0,
        },
    ]
    ...
    return [
        {
            ...
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.accesses",
            "stat_value": 18.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.misses",
            "stat_value": 3.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.readAccesses",
            "stat_value": 10.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.readMisses",
            "stat_value": 2.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.writeAccesses",
            "stat_value": 8.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.dtb.writeMisses",
            "stat_value": 1.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.itb.accesses",
            "stat_value": 7.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.itb.misses",
            "stat_value": 0.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.itb.instAccesses",
            "stat_value": 7.0,
        },
        {
            "workload_id": "w0",
            "parent_window_id": "win0",
            "window_id": "w000",
            "stat_selector": "system.cpu.mmu.itb.instMisses",
            "stat_value": 0.0,
        },
    ]
...
def test_raw_stat_long_contract(tmp_path: Path) -> None:
    ...
    with pytest.raises(ValueError, match="finite"):
        numeric_stat_value(float("nan"), "bad")
...
def test_audit_raw_stat_long_reports_missing_stat() -> None:
    ...
    rows = [
        ...
        if row["stat_selector"] != "system.cpu.commitStats0.committedControl::IsControl"
    ]
    ...
    assert report.iloc[0]["missing_selectors"] == (
...
def test_audit_raw_stat_long_path_and_coverage(tmp_path: Path) -> None:
    ...
    coverage = selector_coverage(model, read_raw_stat_long(path)).set_index(
        "logical_counter"
    )
...
def test_frontend_stall_audit_raw_stat_long() -> None:
    ...
    assert report.iloc[0]["audit_status"] == "Optimal"
    assert report.iloc[0]["counter_values"] == {
        "core_cycles": 20.0,
